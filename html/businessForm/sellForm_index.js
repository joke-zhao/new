define(function (require, exports, module) {
    ...
    var main = new Vue({
        ...
        el: "#main",
        components: {vant},
        template: _g.getTemplate("businessForm/sellForm_index_view"),
        data: {
            //公司名
            deptId: '',
            companyName: "",
        ...
        methods: {
            ...
            selectAmtIncomeByMonth() {
                var self = this;
                //改 + "&date=" + this.value;
                var url = "api/control/erpbusinessData/businessSell?deptName=" + this.companyName + "&date=" + this.value;
                Http.ajax({
                    data: {},
                    isFile: false,
                    isJson: false,
                ...
                if(this.incomeMonthList.length === 0){
                    ...
                    var option = {
                        data: {
                            createHeader: true,
                            tableName:'损益表',
                            title:main.value +'~'+ _g.getLS('companyName') + '~损益表',
