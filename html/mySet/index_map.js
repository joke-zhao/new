define(function(require, exports, module) {
    ...
    var main = new Vue({
        el: '#main',
        template: _g.getTemplate('mySet/index_map_view'),
        data: {
            addressName: "",
            LenovoWord: [],
            id:-1
        ...
        methods: {
            ...
            getMessage(item) {
                ...
                if (api.pageParam.page === "home-peo") {
                    ...
                    _g.execScript({
                        winName: 'index-enterInfo-win', // 必填
                        frameName: 'index-enterInfo-frame', // 可选
                        fnName: 'fnNameMap', // 必填, 要执行的window.xxx, 只需要传入xxx
                        data: {
                            // id:main.id,
                            address: item.address,
                            lon: item.coord.lon, //经度
