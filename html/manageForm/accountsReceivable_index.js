define(function (require, exports, module) {
    ...
    var main = new Vue({
        ...
        el: "#main",
        components: {vant},
        template: _g.getTemplate("manageForm/accountsReceivable_index_view"),
        data: {
            //公司名
            deptId: '',
            companyName: "",
        ...
        methods: {
            selectAmtIncomeByMonth() {
                var self = this;
                var url = "api/control/erppay/selectAmtIncome?deptName=" + this.companyName + "&date=" + this.value;
                Http.ajax({
                    data: {},
                    isFile: false,
                    isJson: false,
            ...
            selectAmtIncomeByYear() {
                var self = this;
                var url = "api/control/erppay/selectAmtIncomeByYear?deptName=" + this.companyName + "&startDate=" + this.startTime + "&endDate=" + this.endTime;
                // var option = {
                //     data: {
                ...
                if(this.incomeMonthList.length === 0){
                    ...
                    var option = {
                        data: {
                            createHeader: true,
                            tableName:'应收账款明细表',
                            title:main.value +'~'+ main.companyName + '~应收账款明细表',
